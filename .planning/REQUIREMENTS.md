...
- [x] **MATH-02**: ExtremalContraction diagnosis — all 5 types (asymptotic, CFT, su(2), symmetric flop, generic flop)
...
- [x] **PIPE-02**: Weyl orbit expansion for hyperextended cone
...
- [x] **INTG-03**: Monkey-patching at Polytope, Triangulation, CalabiYau levels
- [x] **INTG-04**: Version guards on monkey-patches
...
| POL-01 | Phase 5 | Planned |
| POL-02 | Phase 5 | Planned |
| POL-03 | Phase 5 | Planned |
| POL-04 | Phase 5 | Planned |
| POL-05 | Phase 5 | Planned |
| POL-06 | Phase 5 | Planned |
| POL-07 | Phase 5 | Planned |
| POL-08 | Phase 5 | Planned |
| POL-09 | Phase 5 | Planned |
| POL-10 | Phase 5 | Planned |
