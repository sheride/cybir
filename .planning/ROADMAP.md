...
- [ ] **Phase 5: Polish, Validation & h11=3 Survey** - Production polish, safety fixes, orbit validation, and complete h11=3 resolution
...
- [x] 04-02-PLAN.md -- Orbit expansion: apply_coxeter_orbit with correct index conventions, graph orbit, phases=False mode, generator accumulation
- [x] 04-03-PLAN.md -- invariants_for, to_fundamental_domain, delete weyl.py, update re-exports and tests
- [x] 04-04-PLAN.md -- Gap closure: fix reflected phase curve_signs (SC-4) and sym_flop_refs/curves pairing mismatch (WR-04)

### Phase 5: Polish, Validation & h11=3 Survey
**Goal**: Production-quality polish, safety fixes for adaptive GV degree, end-to-end orbit expansion validation on real geometries, non-generic complex structure detection, and complete resolution of all h11=3 EKCs
**Depends on**: Phase 4
...
**Success Criteria** (what must be TRUE):
  ...
  6. Survey notebook/script collecting statistics across all h11=3: phase counts, contraction types, Coxeter groups, cone generators
**Plans:** 3 plans

Plans:
- [ ] 05-01-PLAN.md -- Rich repr/str, non-favorable guard, stability check mode
